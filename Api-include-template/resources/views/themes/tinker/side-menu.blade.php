    ...
    <div @class([
        ...
        <div @class([
            ...
            <div @class([
                ...
                <div
                    class="relative z-10 hidden h-[65px] w-[275px] flex-none items-center overflow-hidden px-5 duration-200 xl:flex group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px] group-[.side-menu--collapsed]:xl:w-[110px]">
                    <a
                        class="flex items-center transition-[margin] duration-200 xl:ml-3 group-[.side-menu--collapsed.side-menu--on-hover]:xl:ml-3 group-[.side-menu--collapsed]:xl:ml-7"
                        href=""
                    >
                        <img
                            class="size-5"
                        ...
                        <div
                            ...
                            <span class="text-base font-medium">REAN</span>
                            <span class="text-base font-light">Pro</span>
                        </div>
                    </a>
                    <a
                                    ...
                                    @if (isset($menu['sub_menu']))
                                        <ul class="{{ $firstLevelActiveIndex == $menuKey ? 'block' : 'hidden' }}">
                                            @foreach ($menu['sub_menu'] as $subMenuKey => $subMenu)
                                                <li x-data="sideMenuDropdown({
                                                    open: {{ $secondLevelActiveIndex == $subMenuKey ? 'true' : 'false' }}
                                                })">
                                                    <a
        ...
        <div @class([
            'content h-screen transition-[margin,width] duration-200 pt-8 pb-12 pl-7 xl:pl-14 pr-7 z-10 relative',
            ...
            'after:absolute after:inset-y-4 after:-ml-px after:right-4 after:left-4 xl:after:left-7 after:bg-[color-mix(in_oklch,_var(--color-background),_var(--color-foreground)_2%)] after:rounded-4xl after:border after:border-foreground/[.15] dark:after:opacity-[.59]',
            'xl:ml-[275px]',
            ...
            <div @class([
                ...
                <div class="h-full overflow-x-hidden">
                    <div
                        ...
                        <div class="group sticky inset-x-0 top-0 z-[999]">
                            <x-base.box
                                class="shadow-foreground/5 flex h-16 items-center gap-5 shadow-lg transition-all before:rounded-2xl after:rounded-2xl"
                            >
                                <div
                                    ...
                                    <div class="hidden group-hover/notifications:block">
                                        ...
                                        >
                                            ...
                                            <div class="mt-1 flex flex-col gap-2.5">
                                                @foreach (array_slice($fakers, 0, 2) as $fakerKey => $faker)
                                                    <a
                                ...
                                <div class="group/profile relative size-9 flex-none">
                                    ...
                                    <div class="hidden group-hover/profile:block">
                                        ...
                                        >
                                            <div class="flex flex-col gap-0.5">
                                                <div class="font-medium">JOINCODER</div>
                                                <div class="mt-0.5 text-xs opacity-70">Developer</div>
                                            </div>
                                            <div class="bg-foreground/5 h-px"></div>
                                            <div class="flex flex-col gap-0.5">
                                                <a
...
@pushOnce('styles')
    @vite('resources/css/themes/tinker/side-menu.css')
