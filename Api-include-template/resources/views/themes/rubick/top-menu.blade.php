...
@section('content')
    <div @class([
        ...
        <div class="border-(--color-nav-foreground)/20 relative z-30 flex h-16 items-center border-b">
            <a
            ...
            <div class="flex h-full grow items-center gap-5 px-7">
                <div
                    class="border-(--color-nav-foreground)/30 open-mobile-menu mr-auto flex size-9 cursor-pointer items-center justify-center rounded-xl border xl:hidden">
                    <x-base.lucide
...
@pushOnce('styles')
    @vite('resources/css/themes/rubick/top-menu.css')
